...
\multicolumn{3}{|p{12cm}|}{Nome do Componente Curricular em Português:} &
\multicolumn{1}{p{4cm}|}{Código:} \\ 
\multicolumn{3}{|p{12cm}|}{\textbf{Segurança, Ética e Riscos em Inteligência Artificial}} &
\textbf{BCC8XX}\\ 
\multicolumn{3}{|p{12cm}|}{Nome do Componente Curricular em Inglês:} & \\ 
...
\multicolumn{4}{|p{16cm}|}{Conteúdo programático:}\\
\multicolumn{4}{|p{\dimexpr 16cm + 6\tabcolsep\relax}|}{%
\begin{enumerate}\item Visão geral dos riscos em Inteligência Artificial.
\item Riscos catastróficos, ética, uso malicioso, corrida tecnológica e riscos organizacionais.
\item Fundamentos de Inteligência Artificial, Aprendizado de Máquina e Deep Learning.
\item Leis de escala, velocidade do desenvolvimento da IA e implicações para segurança.
\item Segurança de agentes individuais: monitoramento e controle.
\item Robustez, generalização, comportamento fora da distribuição e falhas inesperadas.
\item Alinhamento de objetivos, capacidades emergentes e segurança sistêmica.
\item Engenharia de segurança aplicada a sistemas de IA.
\item Decomposição de riscos, confiabilidade e princípios de projeto seguro.
\item Falhas de componentes, fatores organizacionais e acidentes sistêmicos.
\item Eventos extremos, riscos de cauda longa e cisnes negros.
\item Sistemas complexos e sua relevância para a segurança em IA.
\item Interações sistêmicas, efeitos emergentes e riscos sociotécnicos.\end{enumerate}}\\
\multicolumn{4}{|p{16cm}|}{}\\
\hline
\multicolumn{4}{|p{16cm}|}{Bibliografia Básica:}\\
\multicolumn{4}{|p{\dimexpr 16cm + 6\tabcolsep\relax}|}{%
...
\item RUSSELL, Stuart. Human compatible: artificial intelligence and the problem of control. New York: Viking, 2019.
...
\multicolumn{4}{|p{16cm}|}{Bibliografia Complementar:}\\
\multicolumn{4}{|p{\dimexpr 16cm + 6\tabcolsep\relax}|}{%
\begin{itemize}\item BOSTROM, Nick. Superintelligence: paths, dangers, strategies. Oxford: Oxford University Press, 2014.
\item PERROW, Charles. Normal accidents: living with high-risk technologies. Princeton: Princeton University Press, 1999.
...
\multicolumn{3}{|p{12cm}|}{Nome do Componente Curricular em Português:} &
\multicolumn{1}{p{4cm}|}{Código:} \\ 
\multicolumn{3}{|p{12cm}|}{\textbf{Ética, Ação Coletiva e Governança da Inteligência Artificial}} &
\textbf{BCC8YY}\\ 
\multicolumn{3}{|p{12cm}|}{Nome do Componente Curricular em Inglês:} & \\ 
\multicolumn{3}{|p{12cm}|}{\textbf{Ethics, Collective Action, and AI Governance}} & \\ 
\hline
\multicolumn{3}{|p{12cm}|}{Nome e Sigla do Departamento} & Unidade Acadêmica: \\ 
\multicolumn{3}{|p{12cm}|}{Departamento de Computação (DECOM)} & {ICEB} \\ 
\hline
...
\multicolumn{4}{|p{16cm}|}{Ementa:}\\
\multicolumn{4}{|p{16cm}|}{}\\
\multicolumn{4}{|p{\dimexpr 16cm + 6\tabcolsep\relax}|}{Estudo dos princípios éticos e dos desafios de coordenação associados ao desenvolvimento e uso da Inteligência Artificial. Abordagem da IA benéfica e da ética de máquinas, incluindo justiça, viés, bem-estar, preferências humanas, funções de bem-estar social e incerteza moral. Análise de problemas de ação coletiva relacionados à IA, com uso de conceitos de teoria dos jogos, cooperação, conflito e pressões evolutivas. Estudo da governança da Inteligência Artificial em níveis corporativo, nacional e internacional, incluindo crescimento econômico, distribuição de benefícios e governança da capacidade computacional.}\\
\multicolumn{4}{|p{16cm}|}{}\\
\hline
\multicolumn{4}{|p{16cm}|}{Conteúdo programático:}\\
\multicolumn{4}{|p{\dimexpr 16cm + 6\tabcolsep\relax}|}{%
\begin{enumerate}\item Introdução à IA benéfica e à ética de máquinas.
\item Fundamentos éticos aplicados à Inteligência Artificial.
\item Justiça, viés algorítmico e equidade.
\item Preferências humanas, bem-estar e felicidade.
\item Funções de bem-estar social e tomada de decisão coletiva.
\item Incerteza moral e dilemas éticos em sistemas de IA.
\item Problemas de ação coletiva no desenvolvimento da IA.
\item Teoria dos jogos aplicada à cooperação e ao conflito em IA.
\item Corridas tecnológicas, incentivos e pressões evolutivas.
\item Governança corporativa de sistemas de Inteligência Artificial.
\item Governança nacional e políticas públicas para IA.
\item Governança internacional e coordenação global.
\item Distribuição de benefícios, crescimento econômico e desigualdade.
\item Governança da capacidade computacional e recursos estratégicos.\end{enumerate}}\\
\multicolumn{4}{|p{16cm}|}{}\\
\hline
\multicolumn{4}{|p{16cm}|}{Bibliografia Básica:}\\
\multicolumn{4}{|p{\dimexpr 16cm + 6\tabcolsep\relax}|}{%
\begin{itemize}\item HENDRYCKS, Dan. Introduction to AI Safety, Ethics and Society. Boca Raton: Taylor \& Francis, 2024. ISBN 978-1-032-79802-8. Disponível em: <https://www.aisafetybook.com>. Acesso em: 17 dez. 2025.
\item FLORIDI, Luciano. Ethics of artificial intelligence. Oxford: Oxford University Press, 2023.
\item O’NEIL, Cathy. Weapons of math destruction: how big data increases inequality and threatens democracy. New York: Crown, 2016.\end{itemize}}\\
\multicolumn{4}{|p{16cm}|}{}\\
\hline
\multicolumn{4}{|p{16cm}|}{Bibliografia Complementar:}\\
\multicolumn{4}{|p{\dimexpr 16cm + 6\tabcolsep\relax}|}{%
\begin{itemize}\item RAWLS, John. A theory of justice. Cambridge, MA: Harvard University Press, 1971.
\item SEN, Amartya. Development as freedom. New York: Knopf, 1999.
\item EUROPEAN COMMISSION. Ethics guidelines for trustworthy AI. Brussels: European Commission, 2019. Disponível em: <https://digital-strategy.ec.europa.eu>. Acesso em: 17 dez. 2025.
\item BRASIL. Ministério da Ciência, Tecnologia e Inovações. Estratégia brasileira de inteligência artificial (EBIA). Brasília, DF: MCTI, 2021. Disponível em: <https://www.gov.br/mcti>. Acesso em: 17 dez. 2025.
\item ORGANISATION FOR ECONOMIC CO-OPERATION AND DEVELOPMENT. OECD principles on artificial intelligence. Paris: OECD, 2019. Disponível em: <https://www.oecd.org/ai>. Acesso em: 17 dez. 2025.\end{itemize}}\\
\hline
\end{longtable}
\end{center}
